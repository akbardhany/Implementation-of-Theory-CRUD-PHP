      ...
      if ( !empty($_POST)) {
        ...
        // update data
          if ($valid) {
              ...
              $sql = "UPDATE masyarakat  set nik = ?, nama = ?, tempat_lahir = ?, tgl_lahir = ?, jenis_kelamin = ?, gol_darah = ?, alamat = ?, rt = ?, rw = ?, kode_pos = ?, kelurahan = ?, kecamatan = ?, agama = ?, status_kawin = ?, pekerjaan = ?, berlaku_hingga = ?, kewarganegaraan = ?  WHERE id = ?";
              $q = $pdo->prepare($sql);
              $q->execute(array($nik,$nama,$tempat_lahir,$tgl_lahir,$jenis_kelamin,$gol_darah,$alamat,$rt,$rw,$kode_pos,$kelurahan,$kecamatan,$agama,$status_kawin,$pekerjaan,$berlaku_hingga,$kewarganegaraan,$id));
              Database::disconnect();
              header("Location: index.php");
          }
      } else {
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="update.php?id=<?php echo $id?>" method="post">
                      <div class="control-group <?php echo !empty($nikError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="nik" type="text"  placeholder="N.I.K" value="<?php echo !empty($nik)?$nik:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($tgl_lahirError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="tgl_lahir" type="text"  placeholder="TANGGAL LAHIR" value="<?php echo !empty($tgl_lahir)?$tgl_lahir:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($jenis_kelaminError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="jenis_kelamin" type="text"  placeholder="JENIS KELAMIN" value="<?php echo !empty($jenis_kelamin)?$jenis_kelamin:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($gol_darahError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="gol_darah" type="text"  placeholder="GOLONGAN DARAH" value="<?php echo !empty($gol_darah)?$gol_darah:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($rtError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="rt" type="text"  placeholder="RT" value="<?php echo !empty($rt)?$rt:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($rwError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="rw" type="text"  placeholder="RW" value="<?php echo !empty($rw)?$rw:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($kode_posError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="kode_pos" type="text"  placeholder="KODE POS" value="<?php echo !empty($kode_pos)?$kode_pos:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($kelurahanError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="kelurahan" type="text"  placeholder="KELURAHAN" value="<?php echo !empty($kelurahan)?$kelurahan:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($berlaku_hinggaError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="berlaku_hingga" type="text"  placeholder="BERLAKU HINGGA" value="<?php echo !empty($berlaku_hingga)?$berlaku_hingga:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($kewarganegaraanError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="kewarganegaraan" type="text"  placeholder="KEWARGANEGARAAN" value="<?php echo !empty($kewarganegaraan)?$kewarganegaraan:'';?>">
