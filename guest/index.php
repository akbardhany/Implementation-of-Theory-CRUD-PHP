		...
		<div class="simplifica" style="text-align: center; color:#00ff00; font-size: 20px">UNIVERSITAS NAROTAMA | FASILKOM'2K16 | SEMESTER II (PAGI) | TEKNIK PEMROGRAMAN | KELOMPOK 8 | ECP 2</div>
          <div class="row">
              <h3>DATA KAMPUNG | RT 00 RW 00</h3>
					...
					<div class="row" style="text-align:center">
						<h2>Officer Area</h2>
						<p>Selamat datang di Officer Area. Anda Login dengan username <?php echo $_SESSION['guest']; ?></p>
					</div>
          <div class="row">
                <p>
                    <a href="create.php" class="btn btn-success">Create</a>
										<a href="print.php" target="_blank" class="btn btn-warning">Print Out</a>
          ...
          <?php
            ...
            foreach ($pdo->query($sql) as $row) {
                    ...
                    echo '<td width=250>';
                                echo '<a class="btn" href="../guest/read.php?id='.$row['id'].'" target="_blank">Read</a>';
                    echo '</td>';
                    echo '</tr>';
            }
            Database::disconnect();
